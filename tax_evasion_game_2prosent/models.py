...
class Subsession(BaseSubsession):
    ...
    def creating_session(self):
        ...
        #Gir alle spillerene ulike random nummer 28jan
        #for p in players:
        #    p.
...
class Group(BaseGroup):
    ...
    def total_mengde1(self):
        ...
        for pla in players:
            ...
            self.totalt_bidrag = round(self.totalt_bidrag, 3)
    def total_mengde1_fratrukket_skatt_delt_8(self):
        self.total_mengde1()
        self.skatt_hva_man_faar_tilbake = ((self.totalt_bidrag * 0.4)*2)/8
        self.skatt_hva_man_faar_tilbake = round(self.skatt_hva_man_faar_tilbake, 2)
        players = self.get_players()
        for p in players:
    ...
    def totalt_bidrag_choices(self):
        self.session.vars['']
class Player(BasePlayer):
    ...
    def payof_choices(self):
        return self.participant.vars["payof_vars"] 
    def total_payof_choices(self):
        return self.participant.vars["tatal_payof_vars"]
        
    def dinal_total_payof_choices(self):
        return self.participant.vars["final_total_payof_vars"] 